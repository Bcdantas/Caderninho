...
const ProfitPage: React.FC = () => {
  ...
  return (
    <div className="container mt-4">
      ...
      {/* Seção de Gerenciamento de Perdas */}
                  ...
                  expenses.map(expense => (
                    <tr key={expense._id}>
                      ...
                      <td className="text-center">
                          <button className="btn btn-warning btn-sm me-2" title="Editar" onClick={() => handleEditClick(expense)}>
                              <FontAwesomeIcon icon={faEdit} />
                          </button>
                          <button className="btn btn-danger btn-sm" title="Excluir" onClick={() => handleDeleteExpense(expense._id)}>
